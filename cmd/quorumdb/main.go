...
import (
	...
	"github.com/adityagoyal234/quorumdb/internal/api"
	"github.com/adityagoyal234/quorumdb/internal/config"
	"github.com/adityagoyal234/quorumdb/internal/gossip"
	"github.com/adityagoyal234/quorumdb/internal/replication"
	"github.com/adityagoyal234/quorumdb/internal/ring"
	"github.com/adityagoyal234/quorumdb/internal/storage"
	"github.com/adityagoyal234/quorumdb/pkg/types"
)
...
func main() {
	...
	if *showVersion {
		fmt.Printf("QuorumDB v%s (built: %s)\n", version, buildTime)
		os.Exit(0)
	}
	...
	log.Printf("Starting QuorumDB node: %s", cfg.NodeID)
